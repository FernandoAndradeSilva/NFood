...
produtoController.prototype.post = async (req , res) => {
    ...
    _validationContract.isRequired(req.body.descricao, 'O descrição do produto é obrigatória');
    _validationContract.isRequired(req.body.foto, 'A foto do produto é obrigatória');
    _validationContract.isRequired(req.body.preco, 'O preço do produto é obrigatório');
    if(req.body.preco) {
        _validationContract.isTrue(req.body.preco == 0 , 'O preco do produto deve ser maior que 0');
    }
